...
import { ArrowLeft, Save, Eye, Newspaper, Loader2, Image as ImageIcon, HelpCircle } from 'lucide-react';
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      navigate(`/cms/mcq/create?articleId=${articleId}&categoryId=${formData.categoryId}&category=${encodeURIComponent(formData.categoryId || '')}&subCategory=${encodeURIComponent(formData.subCategoryId || '')}&section=${encodeURIComponent(formData.section)}&country=${encodeURIComponent(formData.country)}`);
                    }}
