            ...
            <CardContent className="pt-6 space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    <label className="text-xs text-slate-600 mb-1 block">Lat Long</label>
                    <Input
                      placeholder="Latitude, Longitude"
                      value={`${formData.location.lat}, ${formData.location.long}`}
                      onChange={(e) => {
                        const [lat, long] = e.target.value.split(',').map(s => s.trim());
                        setFormData({
                          ...formData,
                  ...
                  <div className="flex items-end">
                    <Button
                      ...
                      onClick={() => {
                        ...
                        showToast('Map selection coming soon', 'info');
                      }}
                    >
                      Select from Map
                    </Button>
